...
function PuzzleEntry(p, index) {
    ...
    this.aboutPopup = function() {
        ...
        lines.push("<div class='puzzle-about-credits'>This puzzle will save your state if you leave it. Made with <a href='https://github.com/tabascq/PuzzleJS' target='_blank'>Puzzle.js</a></div>")
